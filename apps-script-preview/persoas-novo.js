...
var PERSOAS_PREVIEW_ACEPTACION_SPREADSHEET_ID_ = '1-p5dAqF17LIMwHdSraqoxqN_2NIWIv2VRZjhMhK9SeM';
var PERSOAS_PREVIEW_ACEPTACION_SHEET_ID_ = 1402856251;
var PERSOAS_PREVIEW_TEXTOS_LEGAIS_SHEET_ID_ = 1317527542;
...
/* Texto legal e aceptación. Preview queda illado da Sheet real de produción. */
function contextoAceptacionPersoasAdmin_(){ var libro=SpreadsheetApp.openById(PERSOAS_PREVIEW_ACEPTACION_SPREADSHEET_ID_); var a=libro.getSheetById(PERSOAS_PREVIEW_ACEPTACION_SHEET_ID_), t=libro.getSheetById(PERSOAS_PREVIEW_TEXTOS_LEGAIS_SHEET_ID_); if(!a||!t)throw new Error('Non se atoparon Aceptación/TextosLegais de Preview'); return {aceptacion:a,textos:t}; }
