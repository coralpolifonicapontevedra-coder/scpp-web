...
function gardarProgramaConcertoPortal_(datos) {
  ...
  for (var i = 0; i < items.length; i += 1) {
    ...
    limpos.push({ idRepertorio:idRepertorio, orde:limpos.length + 1, notas:textoEnsaiosPortal_(items[i].notas).slice(0, 1000), solista:textoEnsaiosPortal_(items[i].solista).slice(0, 250) });
  }
