/* Integración no doPost principal. NON crear un segundo doPost.
...
var ACCIONS_ESCRITURA_XESTION_PERMISOS_=['gardarPermisoPortal','eliminarPermisoPortal','rexistrarActividadePortal'];
